...
-   基础应用布局
-   Header、Toolbar、Grand Staff 占位、Piano、Status Bar
...
当前开发版本：
    ...
    Phase 3.1、Phase 3.2、P3-003 已完成，尚未正式发布
...
| `ROADMAP.md` | 下一步计划、任务完成情况 | 每个 Phase 更新 |
| `CHANGELOG.md` | 记录每个版本新增和变更内容 | 每次 Release 更新 |
